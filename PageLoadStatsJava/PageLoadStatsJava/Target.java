...
public class Target {	
	...
	public Target(){
	 ...
	 public HashMap<String,String> getStats(String url, String type){
		 System.out.println("[INFO] getting stats for target: " + url);
		 String html = "";
		...
		int connectionTimeout = 60000;
		 ...
		 try{
			 ...
			 if (responseCode != 200) {
			     System.out.println("[WARNING]   " + responseCode + " when getting stats for: " + url);
		...
		statsMap.putAll(getStatsFromHtml(html));
		 ...
		 System.out.println("[INFO] Target stats gathered for " +url);
		 return statsMap;
	 }
	...
	private HashMap<String, String> getDocStatsMap(String line) {
	 ...
	 public boolean verifyDocContent(String targetId, String sourceHtml){
		 ...
		 try{
			 ...
			 System.out.println("[FAIL] checkFinds() caught an exception for target id " + targetId);
			 return(false);
		 }
		 return true;
	 }
