...
def chart_httperrors(request):
   ...
   # x_axis["labels"] = x_label_obj
    ...
    return HttpResponse(json.dumps(jsonStats), content_type="application/json")
...
def flot_line(request):
    ...
    return HttpResponse(json.dumps(targetsdata), content_type="application/json")
...
def check(request, target_id):
    ...
    return HttpResponse(check_output, content_type="application/json")
